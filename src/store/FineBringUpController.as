   ...
   public class FineBringUpController extends EventDispatcher
   {
      ...
      private function getTempleteInfoByLevel(param1:int, param2:ItemTemplateInfo) : ItemTemplateInfo
      {
         ...
         else if(_loc3_ < param1)
         {
            while(_loc3_ < param1)
            {
               if(param2.FineSuitType == 0)
               {
                  break;
               }
               param2 = ItemManager.Instance.getTemplateById(param2.FineSuitType);
               _loc3_ = int(param2.Property1);
            }
         }
         return param2;
      ...
      public function progress(param1:InventoryItemInfo) : int
      {
         ...
         var _loc4_:int = ItemManager.Instance.getTemplateById(param1.TemplateID).FineSuitType;
         if(_loc4_ == 0)
         {
            return 0;
         }
      ...
      public function expDataArr(param1:ItemTemplateInfo) : Array
      {
         ...
         if(param1.FineSuitType == 0)
         {
            _loc3_ = 0;
         }
         else
         {
            _loc3_ = int(ItemManager.Instance.getTemplateById(param1.FineSuitType).Property2);
         }
