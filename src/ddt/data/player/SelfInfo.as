package ddt.data.player
{
	...
	public class SelfInfo extends PlayerInfo
	{
		...
		private var _dailyMoneyUsed:int = 0; // YENİ EKLEME: Günlük harcanan kupon
		...
		public function get DailyMoneyUsed() : int
		{
			return this._dailyMoneyUsed;
		}
		
		public function set DailyMoneyUsed(param1:int) : void
		{
			if(this._dailyMoneyUsed == param1)
			{
				return;
			}
			this._dailyMoneyUsed = param1;
			onPropertiesChanged("DailyMoneyUsed");
		}
		// -----------------------
