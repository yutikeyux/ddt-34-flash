package ddt.data
{
   ...
   public class ConfigParaser
   {
      ...
      public static function paras(param1:XML, param2:LoaderInfo, param3:String) : void
      {
		 ...
		 if(param1.ACCUMULATIVE.hasOwnProperty("@enable"))
		 {
			 _loc4_.ACCUMULATIVE_ENABLE = param1.ACCUMULATIVE.@enable == "true";
		 }
		 if(param1.FINESTONE.hasOwnProperty("@enable"))
		 {
			 _loc4_.FINESTONE_ENABLE = param1.FINESTONE.@enable == "true";
		 }
		 if(param1.EVOLUTION.hasOwnProperty("@enable"))
		 {
			 _loc4_.EVOLUTION_ENABLE = param1.EVOLUTION.@enable == "true";
		 }
		 if(param1.MAXFORGESTONE.hasOwnProperty("@value"))
		 {
			 _loc4_.MAXFORGESTONE_NUM = param1.MAXFORGESTONE.@value;
		 }
		 if(param1.LABYRINTH.hasOwnProperty("@enable"))
		 {
			 _loc4_.LABYRINTH_ENABLE = param1.LABYRINTH.@enable == "true";
		 }
