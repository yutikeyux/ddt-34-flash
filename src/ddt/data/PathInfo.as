package ddt.data
{
   public class PathInfo
   {
	  ...
	  public var ACCUMULATIVE_ENABLE:Boolean;
	  
	  public var FINESTONE_ENABLE:Boolean;
	  
	  public var EVOLUTION_ENABLE:Boolean;
	  
	  public var MAXFORGESTONE_NUM:int;
	  
	  public var LABYRINTH_ENABLE:Boolean;
