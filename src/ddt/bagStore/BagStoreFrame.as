package ddt.bagStore
{
   ...
   public class BagStoreFrame extends Frame
   {
      ...
      private function initView() : void
      {
		 ...
		 if(PathManager.FineStoneEnable)
		 {
      ...
      private function __changeHandler(param1:Event) : void
      {
         ...
         switch(this._btnGroup.selectIndex)
         {
            ...
            case 1:
               ...
               {
                  this._btnGroup.selectIndex = this._index;
			...
			case 2:
				if(PlayerManager.Instance.Self.Grade >= 45)
				{
					if(!this._fineStoreView)
					{
						this._fineStoreView = new FineStoreView(this._controller,1/*this._controller.selectedIndex["fine_store"]*/);
				...
				{
					MessageTipManager.getInstance().show(LanguageMgr.GetTranslation("ddt.finestore.needlevel"));
					return;
				}
				break;
         }
