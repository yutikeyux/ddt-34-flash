package ddt.manager
{
   ...
   public class MapManager extends EventDispatcher
   {
	  ...
	  private static var _pveNightList:Vector.<DungeonInfo>;
	  ...
	  public static const PVE_NIGHT_MAP:int = 7;
      ...
      public static function getListByType(param1:int = 0) : *
      {
		 ...
		 if(param1 == PVE_NIGHT_MAP)
		 {
			 return _pveNightList;
		 }
         return null;
      }
      ...
      public static function setupDungeonInfo(param1:DungeonAnalyzer) : void
      {
		 ...
		 _pveNightList = new Vector.<DungeonInfo>();
         var _loc2_:int = 0;
         while(_loc2_ < _pveList.length)
         {
			...
			else if(_loc3_.Type == PVE_NIGHT_MAP)
			{
				_pveNightList.push(_loc3_);
			}
            _loc2_++;
         }
	  ...
	  public static function getByOrderingNightDungeonInfo(param1:int) : DungeonInfo
	  {
		  var _loc2_:DungeonInfo = null;
		  for each(_loc2_ in _pveNightList)
		  {
			  if(_loc2_.Ordering == param1)
			  {
				  return _loc2_;
