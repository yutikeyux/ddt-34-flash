package ddt.manager
{
   ...
   public class PathManager
   {
	  ...
	  public static function get AccumulativeEnable() : Boolean
	  {
		  return info.ACCUMULATIVE_ENABLE;
	  }
	  
	  public static function get FineStoneEnable() : Boolean
	  {
		  return info.FINESTONE_ENABLE;
	  }
	  
	  public static function get EvolutionEnable() : Boolean
	  {
		  return info.EVOLUTION_ENABLE;
	  }
	  
	  public static function get MaxForgeStone() : int
	  {
		  return info.MAXFORGESTONE_NUM;
	  }
	  
	  public static function get LabyrinthEnable() : Boolean
	  {
		  return info.LABYRINTH_ENABLE;
	  }
	  
	  public static function solveChristmasMonsterPath(_arg_1:String) : String
	  {
		  return info.SITE + "image/scene/christmas/monsters/" + _arg_1 + ".swf";
	  }
   }
}
