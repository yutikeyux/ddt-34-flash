package ddt.manager
{
   ...
   import ddt.data.socket.PyramidPackageType;
   ...
   public class PyramidManager extends EventDispatcher
   {
      ...
      public function setup() : void
      {
         ...
         SocketManager.Instance.addEventListener(CrazyTankSocketEvent.PYRAMID_SYSTEM,pkgHandler);
      }
      ...
      private function pkgHandler(param1:CrazyTankSocketEvent) : void
      {
         ...
         switch(int(_loc2_))
         {
			 ...
			 case PyramidPackageType.PYRAMID_STARTORSTOP:
               dispatchEvent(new PyramidEvent(PyramidEvent.START_OR_STOP,null,_loc3_));
               break;
			 case PyramidPackageType.PYRAMID_RESULT:
               dispatchEvent(new PyramidEvent(PyramidEvent.CARD_RESULT,null,_loc3_));
               break;
			 case PyramidPackageType.PYRAMID_DIEEVENT:
               dispatchEvent(new PyramidEvent(PyramidEvent.DIE_EVENT,null,_loc3_));
               break;
			 case PyramidPackageType.PYRAMID_SCORECONVERT:
               dispatchEvent(new PyramidEvent(PyramidEvent.SCORE_CONVERT,null,_loc3_));
			   break;
         }
      }
