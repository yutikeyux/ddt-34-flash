         ...
         try
         {
            ...
            switch(pkg.code)
            {
			   ...
			   case ePackageType.STORE_FINE_SUIT:
				   ...
				   break;
			   case ePackageType.EQUIP_GHOST:
			   case ePackageType.SYNC_EQUIP_GHOST:
			   case ePackageType.EQUIP_BRING_UP:
				   dispatchEvent(new PkgEvent(PkgEvent.format(pkg.code),pkg));
				   break;
