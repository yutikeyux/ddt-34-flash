package ddt.view.tips
{
   ...
   public class FineSuitTipsSimple extends BaseTip
   {
      ...
      {
         this._typeNameArr = ["Taş","Bakır","Gümüş","Altın","Yeşim"];
         super();
      }
      ...
      override public function set tipData(param1:Object) : void
      {
         ...
         this._defenceTxt.htmlText = "Savunma <font color=\'#76ff80\'>+" + _loc2_.Defence + "</font>";
         this._luckTxt.htmlText = "Şans <font color=\'#76ff80\'>+" + _loc2_.Luck + "</font>";
         this._magicDefTxt.htmlText = "Büyü Savunması <font color=\'#76ff80\'>+" + _loc2_.MagicDefence + "</font>";
         this._armorTxt.htmlText = "Zırh <font color=\'#76ff80\'>+" + _loc2_.Armor + "</font>";
         this._agilityTxt.htmlText = "Atiklik <font color=\'#76ff80\'>+" + _loc2_.Agility + "</font>";
         this._healthTxt.htmlText = "Can <font color=\'#76ff80\'>+" + _loc2_.hp + "</font>";
      }
   }
}
