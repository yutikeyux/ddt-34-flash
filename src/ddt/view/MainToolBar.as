package ddt.view
{
	...
	public class MainToolBar extends Sprite
	{
		...
		private var _goFarmBtn:BaseButton; //element
		...
		public function initView() : void
		{
			...
			this._goSupplyBtn.visible = false; //element
			...
			this._goFarmBtn = ComponentFactory.Instance.creat("toolbar.gofarmbtn");
			this._goFarmBtn.tipData = "Çiftlik";
			...
			this.allBtns.push(this._goFarmBtn);
		...
		private function initEvent() : void
		{
			...
			this._goFarmBtn.addEventListener(MouseEvent.CLICK,this.__onFarmClick);
		...
		private function removeEvent() : void
		{
			...
			if(this._goFarmBtn != null) {
				this._goFarmBtn.removeEventListener(MouseEvent.CLICK,this.__onFarmClick);
			}
		...
		private function __onFarmClick(param1:MouseEvent) : void
		{
			SoundManager.instance.play("003");
