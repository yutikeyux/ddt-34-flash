package pyramid
{
   ...
   public class PyramidControl extends EventDispatcher
   {
      ...
      {
         PyramidManager.instance.addEventListener(PyramidEvent.START_OR_STOP,__onStartOrStop);
         PyramidManager.instance.addEventListener(PyramidEvent.CARD_RESULT,__onCardResult);
         PyramidManager.instance.addEventListener(PyramidEvent.DIE_EVENT,__onDieEvent);
         PyramidManager.instance.addEventListener(PyramidEvent.SCORE_CONVERT,__onScoreConvert);
      }
      ...
      private function __onStartOrStop(param1:PyramidEvent) : void
      {
         ...
         _loc2_.dataChange(PyramidEvent.START_OR_STOP);
         clearFrame();
      ...
      private function __onCardResult(param1:PyramidEvent) : void
      {
         ...
         _loc2_.dataChange(PyramidEvent.CARD_RESULT);
      }
      ...
      private function __onDieEvent(param1:PyramidEvent) : void
      {
         ...
         _loc2_.dataChange(PyramidEvent.DIE_EVENT);
         clearFrame();
      }
      ...
      private function __onScoreConvert(param1:PyramidEvent) : void
      {
         ...
         var _loc2_:PyramidModel = PyramidManager.instance.model;
         _loc2_.totalPoint = _loc3_.readInt();
         _loc2_.dataChange(PyramidEvent.SCORE_CONVERT);
      }
      ...
      public function showFrame(param1:int, param2:Object = null) : void
      {
         ...
         switch(int(_tipsType) - 1)
         {
            ...
            case 4:
               ...
               _selectedCheckButton.addEventListener(MouseEvent.CLICK,__onselectedCheckButtoClick);
            ...
            case 7:
               ...
               _numberSelecter.addEventListener(Event.CHANGE,__seleterChange);
               PositionUtils.setPos(_numberSelecter,"pyramid.view.autoCountPos");
               (_loc6_ = ComponentFactory.Instance.creatComponentByStylename("pyramid.TipTxt")).text = LanguageMgr.GetTranslation("ddt.pyramid.tipText.content");
         ...
         _tipsframe.addEventListener(FrameEvent.RESPONSE,__onResponse);
      }
      ...
      private function tipsDispose() : void
      {
         ...
         {
            _selectedCheckButton.removeEventListener(MouseEvent.CLICK,__onselectedCheckButtoClick);
            ObjectUtils.disposeObject(_selectedCheckButton);
            _selectedCheckButton = null;
         }
         if(_tipsframe)
         {
            _tipsframe.removeEventListener(FrameEvent.RESPONSE,__onResponse);
