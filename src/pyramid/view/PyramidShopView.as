package pyramid.view
{
   ...
   public class PyramidShopView extends Sprite implements Disposeable
   {
      ...
      {
         _prePageBtn.addEventListener(MouseEvent.CLICK,__pageBtnClick);
         _nextPageBtn.addEventListener(MouseEvent.CLICK,__pageBtnClick);
         _firstPageBtn.addEventListener(MouseEvent.CLICK,__pageBtnClick);
         _endPageBtn.addEventListener(MouseEvent.CLICK,__pageBtnClick);
         PyramidManager.instance.model.addEventListener(PyramidEvent.START_OR_STOP,__stopScoreUpdateHandler);
         PyramidManager.instance.model.addEventListener(PyramidEvent.DATA_CHANGE,__dataChangeHandler);
      }
      ...
      {
         _prePageBtn.removeEventListener(MouseEvent.CLICK,__pageBtnClick);
         _nextPageBtn.removeEventListener(MouseEvent.CLICK,__pageBtnClick);
         _firstPageBtn.removeEventListener(MouseEvent.CLICK,__pageBtnClick);
         _endPageBtn.removeEventListener(MouseEvent.CLICK,__pageBtnClick);
         PyramidManager.instance.model.removeEventListener(PyramidEvent.START_OR_STOP,__stopScoreUpdateHandler);
         PyramidManager.instance.model.removeEventListener(PyramidEvent.DATA_CHANGE,__dataChangeHandler);
      }
