package labyrinth.data
{
	...
	public class LabyrinthModel extends EventDispatcher
	{
		...
		private var _TryAgainCostComplete:Boolean;
		...
		public function get TryAgainCostComplete() : Boolean
		{
			return this._TryAgainCostComplete;
		}
		
		public function set TryAgainCostComplete(param1:Boolean) : void
		{
			this._TryAgainCostComplete = param1;
		}
