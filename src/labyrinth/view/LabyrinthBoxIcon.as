package labyrinth.view
{
	...
	public class LabyrinthBoxIcon extends Sprite implements Disposeable, ITipedDisplay
	{
		...
		{
			var _loc1_:String = "";
			if(LabyrinthManager.Instance.model.myProgress > 20)
			{
			...
			if(LabyrinthManager.Instance.model.myProgress + 2 < this._level)
			{
				_loc1_ = "?";
				this.filters = [this._myColorMatrix_filter];
				ShowTipManager.Instance.removeTip(this);
			}
			else if(LabyrinthManager.Instance.model.myProgress < this._level)
			{
