		...
		private function convertIconInfo($icontype:String, $isopen:Boolean, $timemsg:String, $num:int) : HallIconInfo
		{
			...
			switch($icontype)
			{
				...
				case HallIconType.WORLDBOSSENTRANCE2:
					...
					halltype = HallIcon.WONDERFULPLAY;
					orderid = 16; // Sıralama düzenlendi
					break;
				case HallIconType.WANTSTRONG:
					...
					halltype = HallIcon.WONDERFULPLAY;
					orderid = 17; // Sıralama kaydırıldı
					break;
				case HallIconType.WORLDBOSSENTRANCE4:
					...
					halltype = HallIcon.WONDERFULPLAY;
					orderid = 18; // Sıralama kaydırıldı
					break;
				...
				case HallIconType.FOODACTIVITY:
					halltype = HallIcon.ACTIVITY; // Düzeltildi: 3 yerine ACTIVITY
					orderid = 33;
					break;
