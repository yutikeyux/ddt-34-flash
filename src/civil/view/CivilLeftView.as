package civil.view
{
	...
	public class CivilLeftView extends Sprite implements Disposeable
	{
			...
			if(_loc2_ && _loc2_.info)
			{
				switch(param1.currentTarget)
				{
					case this._talkBtn:
						...
						break;
					case this._equipBtn:
						// AcademyPlayerPanel ile uyumlu olacak şekilde doğrudan görünüm açılıyor.
		...
		private function updatePlayerView() : void
		{
			...
			// Ekipman görüntüleme butonu her zaman aktif ediliyor (Academy mantığı)
			this._equipBtn.enable = true;
