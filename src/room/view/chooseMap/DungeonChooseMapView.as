package room.view.chooseMap
{
   ...
   public class DungeonChooseMapView extends Sprite implements Disposeable
   {
	  ...
	  private var _mapTypBtn_Night:SelectedButton;
      ...
      private function initView() : void
      {
		 ...
		 this._mapTypBtn_Night = ComponentFactory.Instance.creatComponentByStylename("asset.room.TypeBtn_Night");
         addChild(this._mapTypBtn_n);
         addChild(this._mapTypBtn_s);
         addChild(this._mapTypBtn_a);
		 addChild(this._mapTypBtn_Night);
		 ...
		 this._btnGroup.addSelectItem(this._mapTypBtn_Night);
         ...
         this.updateRoomInfo();
         this.initInfo();
         if(PlayerManager.Instance.Self.VIPLevel >= 1 && PlayerManager.Instance.Self.IsVIP && this._btnGroup.selectIndex != 1)
         {
      ...
      private function initInfo() : void
      {
         ...
         switch(RoomManager.Instance.current.dungeonType)
         {
            ...
            case RoomInfo.DUNGEONTYPE_SP:
               ...
               break;
			case RoomInfo.DUNGEONTYPE_NI:
				this._btnGroup.selectIndex = 2;
				this.updateNightItem();
				break;
            default:
               this.updateCommonItem();
         }
      ...
      private function initEvents() : void
      {
		 ...
		 this._mapTypBtn_Night.addEventListener(MouseEvent.CLICK,this.__soundPlay);
      ...
      private function removeEvents() : void
      {
		 ...
		 this._mapTypBtn_Night.removeEventListener(MouseEvent.CLICK,this.__soundPlay);
      ...
      private function __changeHandler(param1:Event) : void
      {
         ...
         {
            if(PlayerManager.Instance.Self.VIPLevel >= 1 && PlayerManager.Instance.Self.IsVIP)
            {
               this.setBossBtnState(true);
            }
            this.updateCommonItem();
	  ...
	  private function updateNightItem() : void
	  {
		  var _loc2_:DungeonMapItem = null;
		  this.reset();
		  var _loc1_:int = 1;
		  while(_loc1_ < DUNGEON_NO)
		  {
			  if(MapManager.getByOrderingNightDungeonInfo(_loc1_))
			  {
				  _loc2_ = this._maps[_loc1_ - 1] as DungeonMapItem;
				  _loc2_.mapId = MapManager.getByOrderingNightDungeonInfo(_loc1_).ID;
			  }
			  _loc1_++;
		  }
	  }
