package room
{
   ...
   public class RoomManager extends EventDispatcher
   {
      ...
      private function _responseII(param1:FrameEvent) : void
      {
         ...
         if(param1.responseCode == FrameEvent.SUBMIT_CLICK || param1.responseCode == FrameEvent.ENTER_CLICK)
         {
            this.__toPaymentTryAgainCostHandler();
         }
         else
         {
            this.__cancelPaymentTryAgainCostHandler();
         }
         ObjectUtils.disposeObject(param1.currentTarget);
      }
      
      private function __toPaymentTryAgainCostHandler() : void
      {
         LeavePageManager.leaveToFillPath();
         GameManager.Instance.dispatchPaymentConfirm();
      }
      
      private function __cancelPaymentTryAgainCostHandler() : void
      {
