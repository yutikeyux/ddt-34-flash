package shop
{
   ...
   public class ShopController extends BaseStateView
   {
	  ...
	        {
		  ...
		  //  Market açıldığında market müziğini çal //ELEMENT
		  SoundManager.instance.playMusic("market");
	        }
	  ...
	        {
		  // arketten çıkarken ana menü (lobi) müziğine geri dön
		  SoundManager.instance.playMusic("62");
