package bagAndInfo.bag
{
   ...
   public class BagView extends Sprite
   {
	  ...
	  private function updateMoney() : void
	  {
		  ...
		  {
			  this._goldText.text = this.formatNumber(this._info.Gold);
			  this._moneyText.text = this.formatNumber(this._info.Money);
			  this._giftText.text = this.formatNumber(this._info.Gift);
			  this._medalField.text = this.formatNumber(this._info.medal);
		  }
		  else
		  {
			  this._goldText.text = this._moneyText.text = this._giftText.text = this._medalField.text = "";
		  }
	  }
	  ...
	  protected function __cellDoubleClick(param1:CellEvent) : void
	  {
		  ...
		  if(_loc6_.NeedSex != _loc7_ && _loc6_.NeedSex != 0) //cinsiyet değiştirme not: yuti
		  {
      ...
      private function __cellUse(param1:Event) : void
      {
		 ...
		 else if(_loc2_.info.TemplateID == EquipType.CHICKACTIVATION_CARDID)
		 {
