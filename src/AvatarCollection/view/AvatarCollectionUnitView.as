package AvatarCollection.view
{
	...
	public class AvatarCollectionUnitView extends Sprite implements Disposeable
	{
		...
		private function autoSelect() : void
		{
			...
			var _loc3_:IListModel = this._list.list.model;
			var _loc4_:int = int(_loc3_.getSize());
			if(_loc4_ > 0)
			{
				if(!this._selectedValue)
				{
					this._selectedValue = _loc3_.getElementAt(0) as AvatarCollectionUnitVo;
				}
				_loc1_ = int(_loc3_.indexOf(this._selectedValue));
				_loc2_ = new IntPoint(0,_loc3_.getCellPosFromIndex(_loc1_));
