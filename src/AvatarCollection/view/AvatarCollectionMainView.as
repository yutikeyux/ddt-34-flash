package AvatarCollection.view
{
	...
	public class AvatarCollectionMainView extends Sprite implements Disposeable
	{
		...
		private function initView() : void
		{
			...
			while(_loc2_ <= 2)
			{
				_loc1_ = new AvatarCollectionUnitView(_loc2_,this._rightView);
				_loc1_.addEventListener(AvatarCollectionUnitView.SELECTED_CHANGE,this.refreshView,false,0,true);
		...
		private function refreshView(param1:Event) : void
		{
			...
			var _loc3_:AvatarCollectionUnitView = param1.target as AvatarCollectionUnitView;
