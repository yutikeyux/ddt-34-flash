package game.view
{
	...
	public class GameViewBase extends BaseStateView
	{
		...
		{
			this._exitRoomTypeArray = [RoomInfo.FRESHMAN_ROOM,RoomInfo.CONSORTIA_BATTLE,RoomInfo.RING_STATION,RoomInfo.ACTIVITY_DUNGEON_ROOM];
			super();
		}
		...
		private function initGameCountDownView() : void
		{
			...
			{
				SocketManager.Instance.out.sendErrorMsg("getTime 1: " + TimeManager.Instance.Now().getTime());
				SocketManager.Instance.out.sendErrorMsg("getTime 2: " + GameManager.Instance.Current.startTime.getTime());
				_loc1_ = 300 - int((TimeManager.Instance.Now().getTime() - GameManager.Instance.Current.startTime.getTime()) / 1000);
				this._gameCountDownView = new GameCountDownView(_loc1_);
