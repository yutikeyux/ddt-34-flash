package calendar.view
{
   ...
   import bagAndInfo.cell.BagCell; //eklendi
   import ddt.data.goods.InventoryItemInfo; //eklendi
   import ddt.manager.ItemManager; //eklendi
   import flash.display.Sprite;
   ...
   public class ActivityDetail extends Sprite implements Disposeable
   {
	  ...
	  private var _awardContainer:Sprite; // eklendi
