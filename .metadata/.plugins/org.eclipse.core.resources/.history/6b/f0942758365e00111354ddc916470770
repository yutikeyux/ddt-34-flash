package pyramid.view
{
   ...
   public class PyramidShopItem extends Sprite implements Disposeable
   {
      ...
      {
         this.addEventListener(MouseEvent.MOUSE_OVER,__shopItemOver);
         this.addEventListener(MouseEvent.MOUSE_OUT,__shopItemOut);
         _shopViewItemBtn.addEventListener(MouseEvent.CLICK,__shopViewItemBtnClick);
      }
      ...
      {
         this.removeEventListener(MouseEvent.MOUSE_OVER,__shopItemOver);
         this.removeEventListener(MouseEvent.MOUSE_OUT,__shopItemOut);
         _shopViewItemBtn.removeEventListener(MouseEvent.CLICK,__shopViewItemBtnClick);
         if(_shopItemInfo)
         {
            _shopItemInfo.removeEventListener(Event.CHANGE,__updateShopItem);
         }
