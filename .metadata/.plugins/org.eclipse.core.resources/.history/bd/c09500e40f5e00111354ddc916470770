package ddt.manager
{
   ...
   public class GameSocketOut
   {
      ...
      public function labyrinthTryAgainCost(param1:Boolean, param2:Boolean) : void
      {
	  ...
	  //
	  public function sendButChristmasGoods(_arg_1:int) : void
	  {
		  var _local_2:PackageOut = new PackageOut(ePackageType.ACTIVITY_SYSTEM);
		  _local_2.writeByte(ChristmasPackageType.CHRISTMAS_PACKS);
	  ...
	  {
		  var _local_1:PackageOut = new PackageOut(ePackageType.ACTIVITY_SYSTEM);
		  _local_1.writeByte(ChristmasPackageType.CHRISTMAS_PLAYERING_SNOWMAN_ENTER);
		  _local_1.writeByte(0);
		  this.sendPackage(_local_1);
	  }
	  
	  public function enterChristmasRoom(_arg_1:Point) : void
	  {
		  var _local_2:PackageOut = new PackageOut(ePackageType.ACTIVITY_SYSTEM);
		  _local_2.writeByte(ChristmasPackageType.CHRISTMAS_PLAYERING_SNOWMAN_ENTER);
		  _local_2.writeByte(2);
	  ...
	  {
		  var _local_1:PackageOut = new PackageOut(ePackageType.ACTIVITY_SYSTEM);
		  _local_1.writeByte(ChristmasPackageType.CHRISTMAS_MAKING_SNOWMAN_ENTER);
		  this.sendPackage(_local_1);
	  }
	  
	  public function getPacksToPlayer(_arg_1:int) : void
	  {
		  var _local_2:PackageOut = new PackageOut(ePackageType.ACTIVITY_SYSTEM);
		  _local_2.writeByte(ChristmasPackageType.GET_PAKCS_TO_PLAYER);
	  ...
	  public function sendChristmasRoomMove(_arg_1:int, _arg_2:int, _arg_3:String) : void
	  {
		  var _local_4:PackageOut = new PackageOut(ePackageType.ACTIVITY_SYSTEM);
		  _local_4.writeByte(ChristmasPackageType.MOVE);
	  ...
	  public function sendChristmasUpGrade(_arg_1:int, _arg_2:Boolean) : void
	  {
		  var _local_3:PackageOut = new PackageOut(ePackageType.ACTIVITY_SYSTEM);
		  _local_3.writeByte(ChristmasPackageType.FIGHT_SPIRIT_LEVELUP);
	  ...
	  {
		  var _local_2:PackageOut = new PackageOut(ePackageType.ACTIVITY_SYSTEM);
		  _local_2.writeByte(ChristmasPackageType.FIGHT_MONSTER);
		  _local_2.writeInt(_arg_1);
		  this.sendPackage(_local_2);
	  }
	  ...
	  {
		  var _local_1:PackageOut = new PackageOut(ePackageType.ACTIVITY_SYSTEM);
		  _local_1.writeByte(ChristmasPackageType.CHRISTMAS_BUY_TIMER);
		  this.sendPackage(_local_1);
	  }
	  //
