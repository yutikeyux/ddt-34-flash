package ddt.manager
{
   ...
   public class GameInSocketOut
   {
	  ...
	        {
		           var _loc4_:PackageOut = new PackageOut(91); // 91: ePackageType.MISSION_ROOM
		           _loc4_.writeByte(119); // 119: MISSION_TRY_AGAIN
		           _loc4_.writeInt(param1);
      ...
      public static function sendMissionTryAgainCost(param1:int, param2:Boolean, param3:Boolean = true) : void
      {
	  ...
	  {
		  //var _loc4_:PackageOut;
		  //(_loc4_ = new PackageOut(145)).writeByte(3);
		  var _loc4_:PackageOut = new PackageOut(ePackageType.ACTIVITY_SYSTEM);
		  _loc4_.writeByte(PyramidPackageType.PYRAMID_RESULT);
		  _loc4_.writeInt(param1);
		  _loc4_.writeInt(param2);
		  _loc4_.writeBoolean(param3);
		  sendPackage(_loc4_);
	  ...
	  public static function sendPyramidRevive(param1:Boolean, param2:Boolean) : void
	  {
		  ...
		  _loc3_.writeByte(PyramidPackageType.PYRAMID_DIEEVENT);
		  _loc3_.writeBoolean(param1);
		  _loc3_.writeBoolean(param2);
		  sendPackage(_loc3_);
	  }
